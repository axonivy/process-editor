...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/release%252F13.2/lastSuccessfulBuild/artifact/build/schema/target/editor-ts/13.2/inscription-tsgen.json';
