...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/simple-rule-engine-exec/lastSuccessfulBuild/artifact/build/schema/target/editor-ts/14.0/process-editor-inscription-tsgen.json';
