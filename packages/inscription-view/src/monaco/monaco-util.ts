...
export namespace MonacoUtil {
  ...
  export async function initialize({
    ...
    const allServiceOverrides = [await CodinGame.keybindingsOverride(), await CodinGame.localizationOverride(), ...loadedServiceOverrides];
    const mergedServiceOverrides = allServiceOverrides.reduce((acc, curr) => ({ ...acc, ...curr }), {});
