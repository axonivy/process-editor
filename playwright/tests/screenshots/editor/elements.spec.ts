...
test('starts', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/start.p.json', waitFor: '.sprotty-graph' });
...
test('intermediate', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/intermediate.p.json', waitFor: '.sprotty-graph' });
...
test('end', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/end.p.json', waitFor: '.sprotty-graph' });
...
test('boundary', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/boundary.p.json', waitFor: '.sprotty-graph' });
...
test('gateway', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/gateway.p.json', waitFor: '.sprotty-graph' });
...
test('workflow', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/workflow.p.json', waitFor: '.sprotty-graph' });
...
test('interface', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/interface.p.json', waitFor: '.sprotty-graph' });
...
test('bpmn', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/bpmn.p.json', waitFor: '.sprotty-graph' });
...
test('sub', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/sub.p.json', waitFor: '.sprotty-graph' });
...
test('ws', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/ws.p.json', waitFor: '.sprotty-graph' });
  await screenshot(editor.element('start:webserviceStart'), 'ws-start');
  await screenshot(editor.element('end:webserviceEnd'), 'ws-end');
});

test('hd', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'dialog/process/test/project/screenshot/hd/hdProcess.p.json', waitFor: '.sprotty-graph' });
...
test('note', async ({ page }) => {
  const editor = await ProcessEditor.openProcess(page, { file: 'process/screenshot/note.p.json', waitFor: '.sprotty-graph' });
