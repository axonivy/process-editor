...
test.describe('url parameters', () => {
  ...
  test('zoom and highlight', async ({ page }) => {
    const processEditor = await ProcessEditor.openProcess(page, { file: 'process/urlparam.p.json', urlQueryParam: '&zoom=321&highlight=183E49FD86C52941-f0' });
  ...
  test('zoom and select', async ({ page }) => {
    const processEditor = await ProcessEditor.openProcess(page, { file: 'process/urlparam.p.json', urlQueryParam: '&zoom=123&select=183E49FD86C52941-f0' });
    const start = processEditor.startElement;
    const viewport = processEditor.viewport();
  ...
  test('theme light', async ({ page }) => {
    ...
    const processEditor = await ProcessEditor.openProcess(page, { file: 'process/urlparam.p.json' });
    await processEditor.expectDarkMode();

    const processEditor2 = await ProcessEditor.openProcess(page, { file: 'process/urlparam.p.json', urlQueryParam: '&theme=light' });
  ...
  test('theme dark', async ({ page }) => {
    ...
    const processEditor2 = await ProcessEditor.openProcess(page, { file: 'process/urlparam.p.json', urlQueryParam: '&theme=dark' });
